...
def create_error_response(
    ...
    """
    response = {"error": {"message": error_message, "code": error_code or "UNKNOWN_ERROR"}}
...
def create_success_response(data: Any, metadata: dict[str, Any] | None = None) -> dict[str, Any]:
    """
    创建成功响应
